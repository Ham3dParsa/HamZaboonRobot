...
# Usage: dry-run: python -m factory.archive.v14_v16.run_v16b_topup --dry-run --limit 8
#        smoke:    python -m factory.archive.v14_v16.run_v16b_topup --lemmas rock,light,pass,flat
#        full:     python -m factory.archive.v14_v16.run_v16b_topup
