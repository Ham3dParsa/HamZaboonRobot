...
| Precard gallery on demand, for human and machine reading | precard/report.py | none | `python -m factory.precard.report --proof-dir out --sample sample.json --limit 50 --run-log run.log --out out\report.html` |
