...
| Render a proof HTML report (v141 shape) | precard/report.py | none | `python -m factory.precard.report --proof-dir out\cutover50 --sample W:\hamzaban_data_factory\pilot\sample200b.json --limit 50 --run-log run.log` |
