...
def render_gallery(cards, meta, phrase_types=None):
    ...
    head = (
        ...
        "outline-offset:2px;}\n"
        "@media (max-width:640px){nav.top{position:fixed;bottom:0;top:auto;"
        "left:0;right:0;display:flex;"
        "flex-wrap:nowrap;overflow-x:auto;-webkit-overflow-scrolling:touch;"
        "padding:.5em;border-top:1px solid var(--line);border-bottom:none;}"
        "nav.top a{flex-shrink:0;white-space:nowrap;}"
