...
The pilot line keeps its own copies and evolves separately.

FIXME (T3): the tie-break below still names the 13-head world
("Society & Culture"); T3 rewires text + guard to the single 16-head
registry ("Society", "Work & Careers", ...).
"""
