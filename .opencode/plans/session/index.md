...
| `plan-study-session-restart-persistence.md` | 1 | Bug 1 (owner report 2026-08-15); issue #363; seam 1 (persistence) + 5 (study UI) | `complete` (PR #364 merged 0fdec76) |
| `plan-freeze-prompt-reveal.md` | 1-4 | Prompt freeze + revealed freeze exploit (2026-08-22); seam 1+5 | `complete` (PR #450 merged 0a9c597) |
