...
| `plan-word-query-card-consistency.md` | 1..2 | — (phase 2 on Persistence seam) | `in-progress` |
| `plan-word-query-card-consistency-phase-02-retrieve-new-retention.md` | 2 | phase 1 | `in-progress` |
