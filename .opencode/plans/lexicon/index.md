...
| `plan-async-cloud-judge.md` | 4/4 done, R1..R7 (PR #789 MERGED 2026-09-21) | — | `complete` |
| `plan-provider-registry.md` | 4/4 REVIEW+PR, F1..F4 (branch refactor/provider-registry) | — | `in-progress` |
