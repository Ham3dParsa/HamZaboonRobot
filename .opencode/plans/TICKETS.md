...
| T05 (owner T05 / local T02) | `fsrs/plan-fsrs-session-completion-phase-02-timestamp-schema.md` | #309 | `feat/fsrs-timestamp-schema` | complete (PR #318 merged) |
| T06 (owner T06 / local T03) | `fsrs/plan-fsrs-session-completion-phase-03-grade-transitions.md` | #309 | `feat/phase-3b-fsrs-scheduling` | complete on behavior branch (PR #336) |
| T07 (phase 4) | `fsrs/plan-fsrs-session-completion-phase-04-due-priority.md` | #309 | `feat/phase-3b-fsrs-scheduling` | complete (committed f7d35be; PR #336) |
| T08 (phase 5) | `fsrs/plan-fsrs-session-completion-phase-05-handler-integration.md` | #309 | `feat/phase-3b-fsrs-scheduling` | complete (committed be97597; PR #336) |
