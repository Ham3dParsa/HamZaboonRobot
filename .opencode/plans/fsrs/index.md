...
| `plan-srs-delete-card-fe-pronounce.md` | 1 (scoped P3-T2) | Phase 2 (merged) | `merged` — LOCKED 2026-08-19 (R1-R10); tickets `plan-srs-delete-card-fe-pronounce-phase-01-db` → `-05-integration-validation`; merged via PR #406 |
