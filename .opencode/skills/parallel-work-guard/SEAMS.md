...
| 2 | AI/LLM Provider | services/ai/ai.py + services/ai/card_validation.py + services/ai/llm_services.py + services/ai/ai_read_cache.py | _client(), ask_json(), ask_card(), ask_batch() |
