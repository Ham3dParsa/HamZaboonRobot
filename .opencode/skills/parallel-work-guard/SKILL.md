...
8. **OC merge loop (چرخه مرج)** — after creating or updating the PR, load the `oc-merge-loop` skill (poll OpenCode deltas, checks, and merge-conflict rebase until mergeable).
