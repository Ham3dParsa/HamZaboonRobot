...
def _card_schema(lang_fa: str, example_lang: str, *, compact: bool) -> str:
    if compact:
        return f"""{{"w":"واژه در زبان {lang_fa}","ph":"/ˈhɛ.loʊ/","m":"معنی فارسی",
...
فقط همین کلیدها را برگردان؛
دقیقاً دو مثال و دو ترجمه متناظر بده. s، a و g اختیاری‌اند؛ اگر مترادف یا متضاد معنادار
وجود داشت، 1-3 مورد متفاوت بده وگرنه [] بگذار."""
    return f"""{{
  "word": "واژه در زبان {lang_fa}",
  "phonetic": "IPA: /ˈeks.ɑːm.pəl/",
  "fa_meaning": "معادل کوتاه فارسی",
  "fa_explanation": "توضیح ۱-۲ جمله‌ای به فارسی",
  "synonyms": ["مترادف ۱", "مترادف ۲"],
  "antonyms": ["متضاد ۱", "متضاد ۲"],
  "examples": [
    "جمله نمونه اول به زبان {example_lang}.",
    "جمله نمونه دوم به زبان {example_lang}."
  ],
  "example_translations": [
    "ترجمه فارسی جمله اول.",
    "ترجمه فارسی جمله دوم."
  ],
  "grammar_tip": "نکته گرامری کوتاه"
}}
دقیقاً دو مثال و دو ترجمه متناظر بده. اگر مترادف یا متضاد معنادار وجود داشت،
1-3 مورد متفاوت بده وگرنه آن فهرست را خالی بگذار."""
...
اگر phonetic در فهرست درخواست است، آن را فقط به صورت یک خط با برچسب IPA برگردان، مثلاً: `IPA: /ˈeks.ɑːm.pəl/`.
