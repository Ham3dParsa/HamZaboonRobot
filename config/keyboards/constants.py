...
BTN_BACK = "↩️ بازگشت"
IBTN_BACK = "↩️ بازگشت"
IBTN_BACK_TO_EDIT = "↩️ بازگشت به ویرایش"
IBTN_CANCEL = "🚫 لغو"
...
IBTN_FIELD_MAX_TPM = "🔢 TPM"
IBTN_FIELD_DAILY_REQ = "📊 سقف روزانه"
IBTN_FIELD_IS_EMERGENCY = "🛡️ پریست اضطراری"
IBTN_FIELD_NAME = "🆔 نام پریست"
IBTN_FIELD_INPUT_COST = "💵 ورودی ($/1M)"
IBTN_FIELD_OUTPUT_COST = "💵 خروجی ($/1M)"
IBTN_FIELD_IN_FALLBACK_CHAIN = "⛓️ عضو فال‌بک"
IBTN_FIELD_PRIORITY = "🔢 اولویت فال‌بک"
...
IBTN_REPORTS_BACK_TO_DAYS = "↩️ بازگشت به روزها"
