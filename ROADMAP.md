...
**In progress:** FSRS-6 migration — Phase 1 (core engine + session engine shell merged, 4-button UI live; DB FSRS wiring stubbed, Tier-3 AI deferred). Next: Phase 3a daily_cards migration → Phase 2 stale-flow cleanup → Phase 3b FSRS data wiring. See `docs/plans/plan_fsrs_migration_v2.md`, `docs/plans/plan_daily_cards_migration.md`, `docs/plans/plan_fsrs_session_cleanup.md`.
