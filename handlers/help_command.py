...
_HELP_INTRO = (
    "درود! من @@BOT@@ هستم. رباتی که با تکیه بر هوش مصنوعی و در قالب فلش‌کارت‌های غنی بهت واژه/عبارت، مثال و نکته‌ی "
    "گرامری یاد می‌ده و با مرور فاصله‌دار کمکت می‌کنه که چیزایی که"
    " یاد می‌گیری رو فراموش نکنی.\n\n"
    "چطور استفاده کنم؟\n"
...
HELP_SECTIONS = [
    {
        ...
        "body": (
            ...
            "همون‌طور که از اسمم پیداست، قراره در مسیر یادگیری زبان هم‌زبونت باشم 💬\n\n"
            "\U0001F4DA هر روز که یه نشست مطالعه شروع می‌کنی:\n"
            "✨ واژه‌های جدید یادت می‌دم\n"
            "🔁 کلمه‌هایی که داری یاد می‌گیری و ممکنه یادت برن رو، دقیقاً سر وقت آماده مرور می‌کنم\n\n"
            ...
            "«همه‌چیز در این سفر قابل شخصی‌سازیه:»\n"
            "   ⚙️ زبان، هدف (مثل ✈️ مهاجرت، 🎓 کنکور) سطحت، و موضوعات مورد علاقه‌ت رو بهم میگی تا محتوا مخصوص خودت باشه.\n"
            "   ❓ می‌تونی هر کلمه‌ی جدید یا سختی که باهاش برخورد می‌کنی رو ازم بپرسی؛ برات کارت کاملشو می‌سازم و می‌تونی تو جعبه‌ی مرورت بذاریش تا در نشست‌های آینده بهت یادش بدم! 📚"
        ),
    },
    {
        "id": "settings",
        ...
        "body": (
            ...
            "▫️ سطحت\n"
            "▫️ پیکربندی نمایش کارت: برای شخصی‌سازی و خاموش/روشن کردن نمایش اجزای فلش‌کارت‌ها، روی هر ردیف بزن تا ✅ یا ⭕️ شه\n\n"
            "مواردی که در دسترس نباشن با 🔒 نشون داده می‌شن.\n"
            "پیکربندی نمایش کارت برای همه فعاله، ولی بعضی گزینه‌های جزئی فقط با اشتراک برنزی به بالا قابل تغییره.\n"
            "⚠️ حواست باشه خاموش کردن بعضی بخش‌ها، تنوع سوال‌های مرحله‌ی «جلوی کارت» رو کم می‌کنه و روی کیفیت یادگیریت اثر می‌ذاره؛ توصیه می‌کنم روشن نگهشون داری.\n\n"
            "استریک روزانه، آمارها و امتیازت، و همینطور تعداد واژه‌های آماده‌ی مرور رو هم همین‌جا می‌بینی.\n\n"
    ...
    },
    {
        ...
        "title": "مطالعه",
        "body": (
            "هر روز به اندازه‌ی سهمیه‌ی اشتراک فعالت کارت می‌گیری:\n"
            "▫️ ✨ واژه‌های جدید\n"
            "▫️ 🔁 واژه‌هایی که زمان مرورشون رسیده\n\n"
            "ابتدا «جلوی کارت» رو می‌بینی، در این مرحله با توجه به پرسش و راهنمایی مطرح‌شده برای یادآوری پاسخ تلاش می‌کنی\nسپس دکمه‌ی «نمایش پاسخ» رو می‌زنی، حالا با دیدن «پشتِ کارت» ۴ تا گزینه داری تا به کارکرد خودت نمره‌ی توصیفی بدی:\n"
            "▫️ برای مرور: از «یادم نیامد» تا «خیلی راحت بود»\n"
            "▫️ برای واژه‌ی جدید: از «کاملاً ناآشنا» تا «کاملاً بلدم»\n\n"
            "بعد از ثبت نمره آخرین کارت یک نشست هم گزارش همون نشست رو می‌بینی.\n\n"
            "روش: دکمه‌ی «📚 مطالعه» رو از منوی پایین بزن."
        ),
    },
    {
        "id": "ask",
        ...
        "body": (
            ...
            "▫️ تلفظ\n\n"
            "با «ذخیره برای مطالعه» می‌ذاریش تو جعبه‌ی مرورت و من بهت یادش میدم.\n"
            "پرسش سقف روزانه داره. \n\n"
    ...
    },
    {
        ...
        "body": (
            ...
            "روش: از داخل «مطالعه» وارد مرور می‌شی."
        ),
    ...
    },
    {
        ...
        "title": "گزارش‌ها",
        "body": (
            "با تکمیل هر نشست «📚 مطالعه»، گزارش اون نشست تولید و  ذخیره می‌شه:\n"
            "▫️ خلاصه کارکردت و نظر من\n"
            "▫️ جزئیات صفحه‌به‌صفحه\n\n"
            "گزارش‌ها تا ۳ روز در دسترس خواهند بود و بعد پاک میشن.\n\n"
            "روش: دستور /reports رو بزن تا فهرست روزها و گزارش‌هات بیاد."
        ),
    },
    {
        "id": "admin",
        ...
        "owner_only": True, "hidden": True,  # deactivated from the help panel for now
    },
]
