...
HELP_SECTIONS = [
    ...
    },
    {
        ...
        "title": "گزارش‌ها",
        "body": (
            "بعد از هر «📚 شروع مطالعه»، گزارش جلسه ذخیره می‌شه: تعداد واژه‌های "
            "مرور شده، درست/نادرست و وضعیت FSRS.\n\n"
            "روش: دستور /reports را بزن تا فهرست گزارش‌های اخیر را ببینی "
            "و با دکمه‌های «جزئیات» و «بازگشت به فهرست» بین خلاصه و جزئیات جابه‌جا شوی."
        ),
    },
    {
        "id": "admin",
