...
async def _handle_full_edit_save(update: Update, context: ContextTypes.DEFAULT_TYPE, preset_name: str):
    ...
    try:
        db.set_preset(
            ...
            timeout_seconds=float(values.get("timeout_seconds", preset_fields.resolve(preset, "timeout_seconds"))),
            temperature=float(values.get("temperature", preset_fields.resolve(preset, "temperature"))),
            max_output_tokens=int(values.get("max_output_tokens", preset_fields.resolve(preset, "max_output_tokens"))),
...
async def _save_ai_preset(update: Update, context: ContextTypes.DEFAULT_TYPE, preset_name: str):
    ...
    try:
        db.set_preset(
            ...
            timeout_seconds=float(edits.get("timeout_seconds", preset_fields.resolve(preset, "timeout_seconds"))),
            temperature=float(edits.get("temperature", preset_fields.resolve(preset, "temperature"))),
            max_output_tokens=int(edits.get("max_output_tokens", preset_fields.resolve(preset, "max_output_tokens"))),
